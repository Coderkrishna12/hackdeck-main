  ...
  return (
    <div className="container mt-5">
      <div className="row">
          ...
          <Link to="/wedding" className="text-decoration-none">
            <div className="card h-100 shadow-sm">
              <div className="card-body">
                ...
                <p className="card-text">A wedding planner ensures the big day runs smoothly by overseeing the details and logistics, allowing the couple to enjoy a stress-free celebration. With creative ideas and expert planning, a wedding planner crafts unforgettable moments tailored to the couple's unique style and preferences.</p>
              </div>
            </div>
          </Link>
        </div>
        ...
        {/* Card for Corporate Event */}
        <div className="col-md-6 mb-4">
          <Link to="/corporateEvent" className="text-decoration-none">
            <div className="card h-100 shadow-sm">
              <div className="card-body">
                <h5 className="card-title">Corporate Event</h5>
                <p className="card-text">A corporate event planner handles everything from venue selection and logistics to catering and entertainment, ensuring a seamless experience that aligns with the company’s goals and brand image. Their expertise helps create impactful, memorable events that foster collaboration, networking, and business growth.</p>
              </div>
            </div>
          </Link>
        </div>

        {/* Card for College Fest */}
        <div className="col-md-6 mb-4">
      ...
      <div className="text-center mt-4">
        <Link to="/createCustomEvent" className="btn btn-outline-success">Create Custom Event</Link>
      </div>
    </div>
  );
}
